...
//	private int refreshTokenValiditySeconds;
	...
	protected AuthorizationServerConfig(AuthenticationManager authenticationManagerBean,
			PasswordEncoder encoder, CustomUserDetailsService userDetailsService,
	...
	/**
	 * In memory client with empty secret, application is a "private" API with a single
	 * client, but Spring forces a client authentication.
	 * <p>
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		clients.inMemory().withClient("my-client-app").secret(encoder.encode(""))
				.scopes("trusted").authorizedGrantTypes("password")
//				.scopes("trusted").authorizedGrantTypes("password", "refresh_token")
