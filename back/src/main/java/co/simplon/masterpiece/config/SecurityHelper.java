...
public class SecurityHelper {
	 ...
	 * <p>
	 * The principal is the string representation of the "user details" object, in other
	 * words its username.
	 */
	...
	/**
	 * Returns the {@code Authentication} object associated to the currently authenticated
	 * principal, or an authentication request token.
	 *
